  ...
  .post(
    ...
    },
    {
      body: t.Object({
        ...
        folderId: t.Optional(t.String({ description: 'Folder ID (omit for root folder)' })),
      }),
      detail: {
        tags: ['Files'],
        summary: 'Create file',
        description: 'Create a new file. If folderId is not provided, file will be created in root folder.',
      },
    }
  )
